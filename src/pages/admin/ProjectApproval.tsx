                    ...
                    filtered.map((p, idx) => {
                        ...
                        return (
                            <div key={p.id} className="grid grid-cols-7 border-b border-border last:border-0 hover:bg-gray-50 transition-colors">
                                ...
                                <div className="h-14 flex items-center px-2 font-medium">
                                    {p.title}
                                </div>
                                <div className="h-14 flex justify-center items-center">{fullname}</div>
                                <div className="h-14 flex justify-center items-center">
                                    ฿{p.funding_goal.toLocaleString()}
                                </div>
                                <div className="h-14 flex justify-center items-center">{dateStr}</div>
                                <div className="h-14 flex justify-center items-center gap-[8px]">
                                    <span className="rounded-full px-2.5 py-0.5 bg-amber-50 text-amber-600 border border-amber-200 text-[12px] font-medium">
                                        รอตรวจสอบ
                                    </span>
                                </div>
                                <div className="h-14 flex justify-center items-center">
