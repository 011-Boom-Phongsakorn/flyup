                            ...
                            students.map((s) => (
                                <div key={s.id} className="grid grid-cols-7 px-[16px] items-center border-b border-border last:border-0">
                                    ...
                                    <div className="py-[14px] flex justify-center gap-[8px]">
                                        <button
                                            onClick={() => handleStudentAction(s.user_id, "approve")}
                                        ...
                                        >
                                            {actionLoading === s.user_id ? <Loader2 size={13} className="animate-spin" /> : <CheckCircle size={13} />}
                                            อนุมัติ
                                        </button>
                                        <button
                                            onClick={() => handleStudentAction(s.user_id, "reject")}
                                            disabled={actionLoading === s.user_id}
                                        ...
                                        >
                                            {actionLoading === s.user_id ? <Loader2 size={13} className="animate-spin" /> : <XCircle size={13} />}
                                            ปฏิเสธ
                                        </button>
                                    </div>
                                </div>
